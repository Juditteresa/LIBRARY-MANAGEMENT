...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="other"/>Other<input type="radio" name="branch" value="ROMANCE"/>ROMANCE<div style="margin-left:80px"><input type="radio" name="branch" value="FANTASY"/>FANTASY<input type="radio" name="branch" value="COMEDY"/>COMEDY</div>
            </div>   
